      ...
      schemas: {
        User: {
          ...
          properties: {
            ...
            role: { type: 'string', enum: ['SUPER_ADMIN', 'ADMIN', 'SALES', 'CTV', 'NPP'], example: 'CTV' },
        ...
        Proposal: {
          ...
          properties: {
            ...
            status: { type: 'string', enum: ['PENDING', 'REVIEWING', 'APPROVED', 'REJECTED', 'CANCELLED', 'CONTRACT_SIGNED', 'CONTRACT_FAILED'], example: 'PENDING' },
            created_at: { type: 'string', format: 'date-time' },
