...
const TILE_PROVIDERS = [
  { id: 'leaflet-osm', name: 'Leaflet + OpenStreetMap', type: 'free', auth_type: 'none', requires_key: false, has_cluster: true, cluster_method: 'plugin', tile_url: 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', style_url: '', attribution: '&copy; OpenStreetMap contributors', subdomains: 'a,b,c', api_key: '', description: 'Miễn phí, mã nguồn mở. Tiles OSM/OpenTopoMap/Esri, không cần key. Tích hợp Leaflet.markercluster.' },
