  ...
  steps: [
    ...
    },
    {
      ...
      substeps: [
        ...
        'Mô hình đầu tư: TDT / Liên kết (LK) / Nhượng quyền (NQ) / Nhượng quyền + Liên kết (NQ_LK — form hiện thêm tab lồng, xem G39).',
        'Loại ưu tiên Cấp 1 / Cấp 2: Cấp 1 là mô hình TDT, còn lại (LK/NQ/NQ_LK...) là Cấp 2.',
        'Loại đất: phân loại khu đất đặt trạm (thương mại dịch vụ, khu công nghiệp, giao thông/bến bãi, ở, nông nghiệp, khác).',
        'Vùng miền: khu vực hành chính của đề xuất, tự điền theo tỉnh.',
