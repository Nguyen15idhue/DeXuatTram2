  ...
  flows: [
    {
      ...
      steps: [
        ...
        { ref: 'G12', note: 'Cả 2 cách đều kiểm tra trùng khoảng cách trước khi lưu; gửi xong marker mới xuất hiện trên bản đồ và vào trạng thái chờ duyệt. Mẹo: bấm "Tạo nhanh" để mở form gọn (chỉ tọa độ + thông tin cơ bản) khi cần gửi vội, bổ sung sau.' },
      ],
    },
    {
      id: 'F2',
      ...
      steps: [
        ...
        { ref: 'G39', note: 'Lưu ý: nếu đề xuất chọn mô hình NQ_LK, kiểm tra đủ cả 2 tab lồng Nhượng quyền / Liên kết trước khi sửa gửi.' },
