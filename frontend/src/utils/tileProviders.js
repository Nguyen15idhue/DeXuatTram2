export const TILE_PROVIDERS = [
  {
    ...
    tile_url_styles: [
      ...
      {
        value: 'esri-imagery', label: 'Vệ tinh',
    ...
    subdomains: 'a,b,c',
    api_key: '',
    description: 'Miễn phí, mã nguồn mở. Tiles OSM/OpenTopoMap/Esri, không cần key. Tích hợp Leaflet.markercluster.',
  },
  {
    id: 'maplibre-osm',
